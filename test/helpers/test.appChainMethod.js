/*
 * Test methods for AppChain and SCS, the resulsts needs to return from 
 * SCS client instead of VNODE.
 *
*/
...
// Note this should be update to use scs_getTransactionCount 
